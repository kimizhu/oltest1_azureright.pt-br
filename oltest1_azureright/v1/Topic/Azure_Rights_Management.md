...
<caps:SxS xmlns:caps="http://schemas.microsoft.com/build/caps/2013/11">
  <caps:SxSTarget locale="pt-BR">
    <developerConceptualDocument xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://dduestorage.blob.core.windows.net/ddueschema/developer.xsd" xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
      <introduction>
        <para>
          <caps:sentence sentenceid="62b83eea4fc0746f132ff6c8d4a52b84" id="tgt1" class="tgtSentence">Esta página apresenta o conjunto de documentação técnica para o Microsoft <token>aad_rightsmanagement_1</token> (Azure RMS) para ajudá-lo a proteger informações confidenciais da sua organização contra acesso não autorizado e controlar como estas informações são usadas.</caps:sentence>
          <caps:sentence sentenceid="23b58def11b45727d3351702515f86af" id="tgt2" class="tgtSentence">  O <token>aad_rightsmanagement_1</token> é um serviço de nuvem e está integrado a outros aplicativos e serviços de nuvem da Microsoft Cloud como, por exemplo, o Office 365 e o Active Directory do Azure.</caps:sentence>
          <caps:sentence sentenceid="145e719c453fbadadee79768f74667aa" id="tgt3" class="tgtSentence"> No entanto, ele também pode ser usado com aplicativos locais e serviços.</caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="c6fa2923fc013e88430215867fa3b41f" id="tgt4" class="tgtSentence">O <token>aad_rightsmanagement_2</token> usa políticas de criptografia, identidade e autorização para ajudar a proteger seus arquivos e email.</caps:sentence>
          <caps:sentence sentenceid="6cee999ea54670dc3aaf3fa7bfdf7566" id="tgt5" class="tgtSentence"> Em comparação com os controles de acesso padrão, como permissões de NTFS, a proteção que é aplicada usando o <token>aad_rightsmanagement_2</token> permanece com os arquivos e emails, independentemente da localização — dentro ou fora de sua organização, redes, servidores de arquivos e aplicativos.</caps:sentence>
          <caps:sentence sentenceid="3cea98f77e893eb1025f89567a366d77" id="tgt6" class="tgtSentence"> Essa solução de proteção de informações mantém você no controle de seus dados, mesmo quando ele são compartilhados com outras pessoas.</caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="3d1e430f66ef0a41b3c0d4361753146d" id="tgt7" class="tgtSentence">Por exemplo, você pode configurar um arquivo para que ele possa ser acessado somente por pessoas em sua organização, ou controlar se o arquivo pode ser editado ou restrito a somente leitura, ou impedir que ele seja impresso.</caps:sentence>
          <caps:sentence sentenceid="a1d4b6ea938e5c3193bcc436be24f8c0" id="tgt8" class="tgtSentence"> Você pode configurar emails da mesma forma e, além disso, impedir que sejam encaminhados ou impedir o uso da opção Responder a todos.</caps:sentence>
          <caps:sentence sentenceid="76c61c663112d6aabc8b0558688c8514" id="tgt9" class="tgtSentence"> Essas tarefas de proteção podem ser simplificadas e racionalizadas para seus usuários finais através de modelos de políticas padronizados.</caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="31d23eeb49a60f86a1641f17c6570b72" id="tgt10" class="tgtSentence">
      Para uma compreensão mais profunda e alguns exemplos, consulte <link xlink:href="aeeebcd7-6646-4405-addf-ee1cc74df5df">What is Azure Rights Management?</link></caps:sentence>
        </para>
        <para>
          <caps:sentence sentenceid="0d618ca3ca5b0a48f105c1e37165a023" id="tgt11" class="tgtSentence">Use as seguintes informações para saber mais sobre o <token>aad_rightsmanagement_1</token> e implantá-lo para a sua organização:</caps:sentence>
        </para>
        <list class="bullet">
          <listItem>
            <para>
        ...
        <para>
          <caps:sentence sentenceid="8f8764b84fbfe3fb41a1de8bd2151a22" id="tgt12" class="tgtSentence">Para obter mais recursos, consulte <link xlink:href="7cc73d92-27d6-49ff-a8ab-2fae73519b4b">Information and Support for Azure Rights Management</link>.</caps:sentence>
        </para>
      </introduction>
      <section>
        <title>
          <caps:sentence sentenceid="b75b1651ff8c1f6e857670d70de57727" id="tgt13" class="tgtSentence">Também conhecido como...</caps:sentence>
        </title>
        <content>
          <para>
            <caps:sentence sentenceid="0bb50d5ace4abd536a35235fd9cca548" id="tgt14" class="tgtSentence">O Azure Rights Management também é conhecido como <legacyItalic>Azure Rights Management Service</legacyItalic>, mas por ser executado como um serviço no Azure, o "serviço" normalmente é omitido do seu nome.</caps:sentence>
            <caps:sentence sentenceid="4ec4858d185533976ae0410b2d35079b" id="tgt15" class="tgtSentence"> É a versão de nuvem do <legacyItalic>Active Directory Rights Management Services</legacyItalic> (AD RMS) que foi inicialmente lançado como <legacyItalic>Windows Rights Management Services</legacyItalic> (Windows RMS).</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="0726a4db7b39858b6c4062cb42e94fe2" id="tgt16" class="tgtSentence">Como RMS é uma abreviação conhecida devido a seus predecessores, o Azure Rights Management é muitas vezes abreviado como <legacyItalic>Azure RMS</legacyItalic>.</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="951d003f6152823990af843b34aa46e3" id="tgt17" class="tgtSentence">O Azure Rights Management foi originalmente denominado <legacyItalic>Windows Azure Active Directory Rights Management</legacyItalic> (muitas vezes abreviado como <legacyItalic>Windows Azure AD Rights Management</legacyItalic>), depois como <legacyItalic>Windows Azure Rights Management</legacyItalic> e, finalmente, como <legacyItalic>Azure Rights Management</legacyItalic>.</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="ae8b2b285d98ab9534ef325989bd0813" id="tgt18" class="tgtSentence">Você também poderá ver referências ao <legacyItalic>Information Rights Management</legacyItalic> muitas vezes abreviado como <legacyItalic>IRM</legacyItalic>.</caps:sentence>
            <caps:sentence sentenceid="bcf8f7f6e8efe34a2816544f253dc99e" id="tgt19" class="tgtSentence"> Isso é a implementação do Office do Rights Management que é compatível com o Azure RMS e o AD RMS.</caps:sentence>
            <caps:sentence sentenceid="814cd385574d9159ca8935f57babd54f" id="tgt20" class="tgtSentence">  Quando o Azure RMS foi lançado, ele só podia ser usado somente com o Office 365 — por exemplo, com uma assinatura do Office 365 E3.</caps:sentence>
            <caps:sentence sentenceid="21c6900dba0d93d29042f515dd3cd695" id="tgt21" class="tgtSentence"> Agora, o Azure RMS foi estendido a outras assinaturas, como o Enterprise Mobility Suite (EMS), e o suporte agora inclui o Office 2016, Office 2013, Office 2010, versões locais do SharePoint e do Exchange e o Azure RMS pode proteger qualquer tipo de arquivo.</caps:sentence>
            <caps:sentence sentenceid="3ce055386165dac9a926371c350ecfed" id="tgt22" class="tgtSentence"> Para obter mais informações, consulte <link xlink:href="2cdc7bde-4044-4021-b887-11476f99afd9">How Applications Support Azure Rights Management</link>.</caps:sentence>
          </para>
          <para>
            <caps:sentence sentenceid="483562e5c3f5a51c6ece6ac16a3e8b0f" id="tgt23" class="tgtSentence">Você também poderá ver referências ocasionais ao <legacyItalic>Microsoft Rights Management</legacyItalic> ou ao <legacyItalic>Microsoft Rights Management Services</legacyItalic>, que é um termo coletivo que pode incluir o Azure RMS e o AD RMS.</caps:sentence>
            <caps:sentence sentenceid="62590b7cc80fa58960258871f90025a1" id="tgt24" class="tgtSentence">  O "<legacyItalic>NOVO Microsoft RMS</legacyItalic>" era um rótulo popular por vezes usado quando o Azure Rights Management foi oficialmente lançado, para enfatizar a nova facilidade de implantação em comparação com seus predecessores no local.</caps:sentence>
          </para>
          <alert class="tip">
            <para>
              <caps:sentence sentenceid="da41105f4520ac7aa5ba99aad81c8f23" id="tgt25" class="tgtSentence">Você encontrará esses termos (e mais) em <link xlink:href="742877bf-26f5-40e3-b1f7-8475e7c3ce11">Terminology for Azure Rights Management</link>.</caps:sentence>
            </para>
          </alert>
          <para>
            <caps:sentence sentenceid="d2584214cdff2107001a9881c3f0d321" id="tgt26" class="tgtSentence">Como uma solução de proteção de informações corporativas, o Microsoft Rights Management Services não fornece soluções de gerenciamento de direitos digitais (DRM) que normalmente protegem contra distribuição ilegal do software digital.</caps:sentence>
          </para>
        </content>
      </section>
